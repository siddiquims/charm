...
class Sequence():
    ...
    def __init__(self, sequence, origin_id, host_id, translation_table_origin=1, translation_table_host=1,
        ...
        sequence                    - DNA or RNA sequence as Bio.Seq object. This can for example be generated by using
                                      BioPython directly or by loading a FASTA file using LibCharm.IO.load_file
