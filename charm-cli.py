...
def autolabel(rects, ax, labels, vertical=True):
    """
    Automatically add labels above a bar in a bar graph.

    rects    - list of bars to be labelled (e.g. generated by ax.bar())
    ax       - axis (axis object from matplotlib)
    labels   - list of labels
    vertical - rotate the labels by 90° if true
...
def plot(sequence, prefix=None):
    ...
    sequence - LibCharm.Sequence object
    prefix   - Resulting plot files will be prefixed with 'prefix'
    """
